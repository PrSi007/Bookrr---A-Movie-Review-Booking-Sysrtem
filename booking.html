...
<html lang="en">
	<head>
		...
		.seat:nth-of-type(2),.seat:nth-of-type(8) {
		margin-right: 32px;
		}
		.booked{
		...
		<div class="container">
			<div class="row">
				<div class="col-12 d-flex align-items-center notations justify-content-center">
					<div class="notation n1 shadow"></div><div><h6>Not Booked</h6></div>
					<div class="notation n2 ml-3 shadow"></div><div><h6>Selected</h6></div>
					<div class="notation n3 ml-3 shadow"></div><div><h6>Booked</h6></div>
				</div>
				<div class="col-11 ml-2 my-3">
					<select id="movie" class="form-control shadow">
						<option value="100">Movie A - &#8377;389</option>
						<option value="130">Movie B - &#8377;479</option>
						<option value="150">Movie C - &#8377;399</option>
						<option value="180">Movie D - &#8377;599</option>
					</select>
				</div>
			</div>
			<!-- row  -->
    ...
    function saveToLocalStorage(userSlectedmovie){
        ...
        switch(userSlectedmovie){
            case '100': localStorage.setItem('movie1Id', dd);break;
            case '130': localStorage.setItem('movie2Id', dd);break;
            case '150': localStorage.setItem('movie3Id', dd);break;
            case '180': localStorage.setItem('movie4Id', dd);break;
    ...
    function updateView(usm){
        ...
        console.log(usm);
        switch(usm){
            case '100':selectedMovieInUpdateView='movie1Id'; break;
            case '130':selectedMovieInUpdateView='movie2Id'; break;
            case '150':selectedMovieInUpdateView='movie3Id'; break;
            case '180':selectedMovieInUpdateView='movie4Id'; break;
            default:console.log('invalid operation');break;
        }
        ...
        let BookedMovie;
        switch(usm){
            case '100':BookedMovie='movie1Booked'; break;
            case '130':BookedMovie='movie2Booked'; break;
            case '150':BookedMovie='movie3Booked'; break;
            case '180':BookedMovie='movie4Booked'; break;
            default:console.log('invalid operation');break;
        }
...
// booking Logic
    document.getElementById('save').addEventListener('click',()=>{
        ...
        switch(document.getElementById('movie').value){
            case '100' :currntMovie='movie1Id';break;
            case '130' :currntMovie='movie2Id';break;
            case '150' :currntMovie='movie3Id';break;
            case '180' :currntMovie='movie4Id';break;
        }


        let bookingArray;
        switch(document.getElementById('movie').value){
            case '100' :bookingArray='movie1Booked';break;
            case '130' :bookingArray='movie2Booked';break;
            case '150' :bookingArray='movie3Booked';break;
            case '180' :bookingArray='movie4Booked';break;
        }
