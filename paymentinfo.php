...
<div class="row"  style="padding:50px 150px;">
  <div class="col-50">
    <div class="container" >
      <form  action="paymentgateway.php" method="post" style="padding: 25px;">
      
        <div class="row" >
          <div class="col-25">
            <h3 style="text-align: center;margin:20px 10px;font-family: 'Righteous', cursive;">Payment Info</h3>
            ...
            <input type="hidden" value="<?php echo 249;?>" name="amount">
